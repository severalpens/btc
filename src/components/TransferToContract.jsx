...
export default function TransferToContract(props) {

  const [tokenAddress, setTokenAddress] = useState('0x0');
  const [tokenTransferAmount, setTokenTransferAmount] = useState('10000');
  ...
  return (
    <div className="ml-16 my-16 ">
      <h2 className="font-medium leading-tight text-4xl mt-0 mb-8 text-blue-600">Transfer to Contract</h2>
